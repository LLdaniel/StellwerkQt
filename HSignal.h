...
class HSignal : public QObject{
 ...
 public:
  ...
  void setZiel( QString zziel );//Setzt das ziel, je nach dem, ob es ein W oder S ist
...
public slots:
 ...
 protected:
  QString s_id;//ID des Hauptsignals zB. S002, S511
  ...
  QList<VSignal*> vorsignalR;//involvierten Vorsignale werden hier gespeichert-->rückwärts gesehen!
  QList<VSignal*> vorsignalV;//involvierten Vorsignale werden hier gespeichert-->vorwärts gesehen!
  QList<WSignal*> wsignaleV;//involvierten WSignale im Modus als VS [vor]
  QList<WSignal*> wsignaleR;//involvierten WSignale im Modus als VS [rück]
  QList<QPair<QString , QList<QPair<Weiche* , bool>> > > weichenstatusZuRangier;//Weichenstatus gespeichert für Übergang zur Rangierfahrt
  QList<QPair<QString, QList<Block*>> > blockZuRangier;//Blöcke für den Übergang zur Rangierfahrt
  ...
  QPair<QGraphicsRectItem*,QGraphicsRectItem*> speicheritems;//Die hellen Punkte zur Anzeige, dass Speicher aktiv ist
