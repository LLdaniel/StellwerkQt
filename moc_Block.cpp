...
QT_MOC_LITERAL(1, 6, 11), // "zugpassiert"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 12), // "zugpassiertW"
QT_MOC_LITERAL(4, 32, 11), // "setB_status"
QT_MOC_LITERAL(5, 44, 6) // "status"

    },
    "Block\0zugpassiert\0\0zugpassiertW\0"
    "setB_status\0status"
};
...
void Block::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->zugpassiert(); break;
        case 1: _t->zugpassiertW(); break;
        case 2: _t->setB_status((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Block::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Block::zugpassiert)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Block::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Block::zugpassiertW)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Block::zugpassiert()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Block::zugpassiertW()
{
